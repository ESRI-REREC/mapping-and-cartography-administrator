/* ---------------------------------------------------------------------------
 * oauth.js — named-user sign-in for the Mapping & Cartography UI.
 *
 ...
 * (so navigating index → map doesn't re-run the OAuth redirect each time). */
const STORE_KEY = "mapcarto_esri_auth";
